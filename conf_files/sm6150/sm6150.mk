CONFIG_PATH := $(TARGET_HALS_PATH)/media/conf_files/$(MSMSTEPPE)
...
ifeq ($(GENERIC_ODM_IMAGE)$(TARGET_BOARD_AUTO),truetrue)
  ...
  DEVICE_MANIFEST_FILE += $(TARGET_HALS_PATH)/media/conf_files/sm6150/c2_manifest_vendor.xml
  ...
  DEVICE_MANIFEST_FILE += $(TARGET_HALS_PATH)/media/conf_files/sm6150/c2_manifest.xml
  endif
